function renderPagination(t,e,i,s){var n="en"==i?"/posts":"/es/posts",i="",o=(i+=1==s?`
    <li class="page-item disabled">
      <a class="page-link" rel="nofollow">Previous</a>
    </li>
    `:`
    <li class="page-item">
      <a class="page-link" href="${n}?page=${s-1}">Previous</a>
    </li>
  `,s==t?`
    <li class="page-item disabled">
            ...
            <div class="post col-md-6 col-lg-4">
              <div class="post-item h-100 d-flex flex-column">
                ...
                <div class="content">
                  ...
                  <div class="read-more">
                    <a href="${e.url}" title="${o} ${e.title}" class="btn btn-primary">${n}</a>
                  </div>
                </div>
              </div>
            </div>
          `;6==++t&&(t=0),i+=e})}t.innerHTML=i,1<e.pages&&renderPagination(e.pages,s,r,a)}).catch(function(e){console.log("error: "+e)})}});