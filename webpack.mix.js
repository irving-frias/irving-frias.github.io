...
function generateHtaccess(routes) {
    let htaccessContent = `
        ...
        # Habilitar Cache-Control para archivos estáticos
        <IfModule mod_headers.c>
            <FilesMatch "\.(js|css|png|jpg|jpeg|gif|ico|svg|woff2?|ttf|otf|eot)$">
    ...
    try {
        ...
        console.log('✔ .htaccess file generated successfully with caching rules');
    } catch (error) {
...
function generateRobotsTxt() {
    ...
    try {
        fs.writeFileSync('dist/robots.txt', robotsTxtContent, 'utf8');
        console.log('✔ robots.txt file generated successfully');
    } catch (error) {
        console.error('❌ Error generating robots.txt file:', error);
    }
}
